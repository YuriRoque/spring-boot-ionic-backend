...
public class DBService {
  ...
  public void instantiateTesteDatabase() throws ParseException {
    ...
    Cliente cli1 = new Cliente(null, "Maria Silva", "yrbenvenutti@hotmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
    cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

    Cliente cli2 = new Cliente(null, "Ana Costa", "yrbenvenutti@gmail.com", "50464505003", TipoCliente.PESSOAFISICA,
        pe.encode("123"));
    cli2.getTelefones().addAll(Arrays.asList("22331122", "989548492"));
    cli2.addPerfil(Perfil.ADMIN);

    Endereco e1 = new Endereco(null, "Rua FLores", "300", "Apto 203", "Jardim", "38220834", cli1, c1);
    Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
    Endereco e3 = new Endereco(null, "Av. Floriano", "2106", null, "Centro", "78722728", cli2, c2);
